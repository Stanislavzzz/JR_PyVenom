...
- Использование дополнительных хэндлеров
...
- Если не публикуете проект на сервере, то обязательно приложить в 
  директорию screenshots (в папке проекта) скрины с работой бота.
...
2. На занятиях реализуем и разберем шаблон проекта.
